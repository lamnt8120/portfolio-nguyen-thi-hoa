    ...
    >
            ...
            <div className="flex flex-col">
              ...
              <div className="relative mb-12 p-1.5 bg-white shadow-[0_20px_60px_-15px_rgba(0,0,0,0.08)] rounded-sm overflow-hidden">
                <img 
                  ...
                  className="w-full aspect-[4/5] md:aspect-[3/4] lg:aspect-[4/5] object-cover object-top grayscale-[10%] hover:grayscale-0 transition-all duration-700"
                />
              </div>
      ...
      <section id="cong-dong" className="py-24 md:py-32 bg-white">
        <div className="max-w-7xl mx-auto px-6 lg:px-12">
          ...
          <div className="bg-gradient-to-br from-[#0d3a3c] to-[#1d6266] rounded-3xl mb-24 relative overflow-hidden shadow-xl flex flex-col lg:flex-row group text-white mt-12">
