                      ...
                      <div key={idx} 
                        ...
                        <div className="flex items-center justify-between">
                          <div className="flex items-start">
                             ...
                             <h5 className="text-[13px] lg:text-[14.5px] font-bold text-white leading-snug mt-0.5 lg:mt-1 group-hover:text-[#2eb793] transition-colors pr-2 lg:pr-4">{item.title}</h5>
                          </div>
                        ...
                        <div className={`grid transition-all duration-300 ease-in-out ${isActive ? 'grid-rows-[1fr] mt-3 pt-3 lg:mt-4 lg:pt-4 border-t border-white/10 opacity-100' : 'grid-rows-[0fr] opacity-0'}`}>
                          <div className="overflow-hidden">
                             ...
                             <p className="text-[12.5px] lg:text-[13.5px] text-white/90 font-medium leading-relaxed">{item.desc}</p>
                          </div>
                        </div>
                      </div>
                    )
